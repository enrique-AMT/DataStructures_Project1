...
-testers: Contains DiskUnitTester0, which creates 5 Virtual Disk Units and DiskUnitTester1-5, which reads the contents of the created units.
...
5. For disks 2-5, run classes DiskUnitTester2.java through DiskUnitTester5.java.
...
6. Once that you've verified the existence of the disks, run the following command for testing the disk contents
	...
	java -classpath bin testers.DiskUnitTester2
	java -classpath bin testers.DiskUnitTester3
	java -classpath bin testers.DiskUnitTester4
	java -classpath bin testers.DiskUnitTester5
